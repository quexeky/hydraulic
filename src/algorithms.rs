...
pub trait Algorithm {
    ...
    fn partial_encode(&self, data: &[u8], meta: &AlgorithmMeta) -> Result<Vec<u8>, CompressionError>;
    fn partial_decode(&self, data: &[u8], meta: &AlgorithmMeta) -> Result<Vec<u8>, DecompressionError>;
}